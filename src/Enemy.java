...
public class Enemy extends GameObject {
	...
	public BufferedImage EmuLeft = GamePanel.EmuLeft;
	public BufferedImage EmuRight = GamePanel.EmuRight;
	...
	public void draw(Graphics g) {
		...
		// collisionBox.height);
		if (speed>0) {
			g.drawImage(EmuLeft, x, y, width, height, null);
		}
		else {
			g.drawImage(EmuRight, x, y, width, height, null);
		}
